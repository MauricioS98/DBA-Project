    ...
    <div class="home-page">
      <section class="app-hero">
        <div class="app-hero__content">
          <h1 class="app-hero__title">InvestigaciÃ³n UD</h1>
          <p class="app-hero__subtitle">Sistema de GestiÃ³n de Grupos de InvestigaciÃ³n</p>
          <p class="app-hero__text">
            Centraliza, consulta y gestiona la informaciÃ³n de los grupos de investigaciÃ³n
            de la Facultad de IngenierÃ­a de la Universidad Distrital.
          </p>
      ...
      <section class="app-features">
        ...
        <div class="app-grid app-feature-grid">
          ...
          <article class="app-feature-card">
            <div class="app-feature-card__icon" aria-hidden="true">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" focusable="false">
